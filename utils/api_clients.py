    ...
    *,
    ...
    if use_responses_api:
        ...
        system_prompt = (
            ...
            "【核心创作策略：根据话题类型匹配风格】\n"
            "1. 科技/商业类（如机器人、汽车、芯片）：必须采用【好莱坞科幻大片/苹果发布会】的高端美学。\n"
            "   ⚠️ 致命警告（实体锚定）：如果新闻涉及具体的科技产品（如宇树机器人），必须在画面中保留该实体的物理形态（如：流线型的银色机械狗、极具未来感的仿生人、精密的机械臂），将其描绘得极具工业设计感。绝对禁止将其替换为“悬浮光球”、“魔法水晶”、“超能力”等玄幻/魔法元素！\n"
